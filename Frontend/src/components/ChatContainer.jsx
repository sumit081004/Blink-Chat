...
useEffect(() => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      {/*--- Header Section ----*/}
      <div className='fex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
      ...
      <div className='flex flex-col p-3 pb-23 h-[calc(100%-80px)] overflow-y-auto'>
      ...
      {/*--- bottom area ----*/}
             <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
                    ...
                    <input onChange={handleSendImage} type="file" 
                     id='image' accept='image/png, image/jpeg'  hidden/>
                    <label htmlFor='image'>
                      <img src={assets.gallery_icon} alt="" className="w-5 mr-2 cursorpointer" />
                      </label>
    ...
    <div className='flex flex-cool items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
